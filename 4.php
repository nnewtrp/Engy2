                    ...
                    <div class="tm-right-column">
                        ...
                        <div class="tm-content-div">
                            ...
                            <section id="welcome" class="tm-section">
                                <header>
                                    <h2 class="tm-black-text tm-welcome-title tm-margin-b-45">Bus Route: 4</h2><br>
									<h5>
									<?php
									$q="SELECT Description FROM Route WHERE Route_ID=5";
								...
								<table  class="tableinfo">
									...
									<?php
									$q="SELECT Sequence,Station_Name FROM Route_Station R LEFT JOIN Station S ON R.Station_ID = S.Station_ID WHERE R.Route_ID=5";
									$result=$mysqli->query($q);
