                    ...
                    <div class="tm-admin-bg tm-left-column">   
                        ...
                        <nav class="tm-main-nav">
                            <ul class="tm-main-nav-ul">
								...
								-->
                                <li class="tm-nav-item">
                                    <a href="Bus.php" class="tm-nav-item-link">Bus</a>
                                </li>
								<li class="tm-nav-item">
                        ...
                        <div class="tm-content-div">
                            ...
                            <section id="welcome" class="tm-section">
                                <header>
									...
									<form action="buscontrol4.php" method="POST">
									...
									<?php 	
											  ...
											  $round=$_POST['Round'];
											  $busid=$_POST['busid'];
											  echo "Bus ID: $busid"; echo"<br>";
											  echo "Route :  $route &nbsp&nbsp";
											  echo "Round  : $round";
											  echo "<br>";
											  $time=date("h:i:s");
											  echo $time;
									...
									?>
										...
										<input type="submit" name="a" value="Arrive">
									...
									if(isset($_POST['arrive'])){
										...
										$qu="INSERT INTO bus_station (RouteID, RoundID, StationID, Arrival, BusID) VALUES (1, 1 ,3, '22:45:47', 1)";
										$quresult =$mysqli->query($qu);
