                    ...
                    <div class="tm-right-column">
                        ...
                        <div class="tm-content-div">
                            ...
                            <section  class="tm-section">
								...
								<h2 style="text-align:center"> Please select the option below </h2>
								<br>
								<div class="center">
									<a href="driversearch.php" class="tm-button tm-button-wide">Search</a>
								</div>
								<br>
								<div class="center">
									<a href="driverall.php" class="tm-button tm-button-wide">See all</a>
								</div>
