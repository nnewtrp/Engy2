                        ...
                        <div class="tm-content-div">
                            ...
                            <section  class="tm-section">
								...
								<table  class="tableinfo">
									...
									<?php
									$q="SELECT * FROM PASSENGER WHERE AccountType='user'";
									$result=$mysqli->query($q);
									while($row=$result->fetch_array()){ ?>
									<tr>
										<td class="tableinfo"> <?php echo  $row[0]?> </td>
										<td class="tableinfo"> <?php echo  $row[2]?> <?php echo  $row[3]?> </td>
										<td class="tableinfo"> <?php echo  $row[4]?> </td>
										<td class="tableinfo"> <?php echo  $row[5]?> </td>
										<td class="tableinfo"> <?php echo  $row[6]?> </td>
										<td class="tableinfo"> <?php echo  $row[7]?> </td>
									</tr>
									<?php } ?>
								</table>
                            </section>
